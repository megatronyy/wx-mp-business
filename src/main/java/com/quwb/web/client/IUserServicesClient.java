...
public interface IUserServicesClient {
    @RequestMapping(value = "/user/announces/{userId}", method = {RequestMethod.GET})
    String getAnnounceListByUserId(@PathVariable(name = "userId", required = true) Integer userId);
}
